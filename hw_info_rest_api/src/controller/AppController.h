 ...
 public:
  ...
  ENDPOINT("GET", "/ipv4", ipv4) {
	...
	try {
	  ...
	  return createDtoResponse(Status::CODE_500, ifInfoList);
	}
  }
  ...
  ENDPOINT("GET", "/meminfo", meminfo) {
	...
	try {
	  ...
	  MemDescr memDescr(mem_info_collector.memTotal(),
						mem_info_collector.memFree(),
						mem_info_collector.memAvailable(),
						mem_info_collector.swapTotal(),
						mem_info_collector.swapFree());
	  ...
	  return createDtoResponse(Status::CODE_500, nullptr);
	}
  }
  ENDPOINT("GET", "/hddinfo", hddinfo) {
	...
	try {
	  ...
	  return createDtoResponse(Status::CODE_500, hdd_info_list_dto);
	}
  ...
  ENDPOINT("GET", "/cpuinfo", cpuinfo) {
	...
	try {
	  ...
	  return createDtoResponse(Status::CODE_500, cpu_info_list_dto);
	}
